    ...
    <div id="carouselExampleIndicators" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="false">
        <div class="carousel-inner">
            <div class="carousel-item active">
                ...
                <picture>
                    <source media="(max-width: 799px)" srcset="{{ asset('front-assets/images/backgr-m.jpg') }}" />
                    <source media="(min-width: 800px)" srcset="{{ asset('front-assets/images/backgr.jpg') }}" />
                    <img src="{{ asset('front-assets/images/backgr.jpg')  }}" alt="" />
                </picture>

                <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                    <div class="p-3">
                        <h1 class="display-4 text-white mb-3">Global Fashion</h1>
                        <p class="mx-md-5 px-5">Store has so many unisex clothes, that's suitable for all people. Basic but Luxury</p>
            ...
            <div class="carousel-item">
                ...
                <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                    <div class="p-3">
                        <h1 class="display-4 text-white mb-3">Global Fashion</h1>
                        <p class="mx-md-5 px-5">Price is cheaper than some store. Besides, Coupon is always provided to customer </p>
                        <a class="btn btn-outline-light py-2 px-4 mt-3" href="{{ route('front.home') }}">Shop Now</a>
                    </div>
                </div>
            </div>
